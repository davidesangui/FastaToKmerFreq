...
parser.add_argument("-output_type",help="Type of output. single_files: one numpy array for each fasta file. fasta_matrix: one numpy matrix where each row stores the kmer frequencies of the corresponding fasta file as indicated in the output index. contig_matrix: one numpy matrix where each row stores the kmer frequencies of the corresponding contig as indicated in the output index. All contigs from all fasta files are stored in this matrix. Default: single_files",choices=['single_files','fasta_matrix','contig_matrix'],default='single_files')
